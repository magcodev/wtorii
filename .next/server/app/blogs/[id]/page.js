...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47727)), "C:\\wtorii\\src\\app\\blogs\\[id]\\page.js"],
...
const pages = ["C:\\wtorii\\src\\app\\blogs\\[id]\\page.js"];
...
module.exports = createProxy("C:\\wtorii\\node_modules\\next\\dist\\client\\link.js");
...
;// CONCATENATED MODULE: ./src/utilities/loadSingleBlog.js
...
/* harmony default export */ const utilities_loadSingleBlog = (loadSingleBlog);
...
;// CONCATENATED MODULE: ./src/app/blogs/[id]/page.js
...
const SingleBlog = async ({ params })=>{
    ...
    const { id, title, image, description, date } = await utilities_loadSingleBlog(params.id);
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "md:min-h-screen mt-16 md:w-2/3 mx-auto",
        children: [
...
/* harmony default export */ const page = (SingleBlog);
...
var __webpack_exports__ = __webpack_require__.X(0, [587,60,249,178,514], () => (__webpack_exec__(33335)));
